package dheeraj.sachan.advancedandroidshit.test;/*
 ...
 */
public class CustomActionMenuPresenter extends BaseMenuPresenter
        implements ActionProvider.SubUiVisibilityListener {

    private static final String TAG = "CustomActionMenuPresenter";
    ...
    public CustomActionMenuPresenter(Context context) {
    ...
    public MenuView getMenuView(ViewGroup root) {
        ...
        ((CustomActionMenuView) result).setPresenter(this);
        return result;
    }
    ...
    public View getItemView(final MenuItemImpl item, View convertView, ViewGroup parent) {
        ...
        final CustomActionMenuView menuParent = (CustomActionMenuView) parent;
    ...
    public void bindItemView(MenuItemImpl item, MenuView.ItemView itemView) {
        ...
        final CustomActionMenuView menuView = (CustomActionMenuView) mMenuView;
    ...
    public boolean flagActionItems() {
        ...
        for (int i = 0; i < itemsSize; i++) {
            ...
            if (item.requiresActionButton()) {
                ...
                if (mStrictWidthLimit) {
                    cellsRemaining -= CustomActionMenuView.measureChildForCells(v,
                ...
                if (isAction) {
                    ...
                    if (mStrictWidthLimit) {
                        final int cells = CustomActionMenuView.measureChildForCells(v,
                                cellSize, cellsRemaining, querySpec, 0);
    ...
    public void setMenuView(CustomActionMenuView menuView) {
        mMenuView = menuView;
