 ...
 */
public class CustomActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker,
        MenuView {
    ...
    private CustomActionMenuPresenter mPresenter;
     ...
     * @hide
     */
    public void setPresenter(CustomActionMenuPresenter presenter) {
    ...
    public Menu getMenu() {
        if (mMenu == null) {
            ...
            mPresenter = new CustomActionMenuPresenter(context);
    ...
    private class ActionMenuPresenterCallback implements CustomActionMenuPresenter.Callback {
        @Override
