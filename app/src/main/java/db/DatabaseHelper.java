...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private static final String DATABASE_NAME = "com.dheeraj.db";
    private static final int DATABASE_VERSION = 1;

    private Dao<Table, Long> tableLongDao;
    ...
    public Dao<Table, Long> getTableLongDao() throws SQLException {
        if (tableLongDao == null) {
            tableLongDao = getDao(Table.class);
        }
        return tableLongDao;
    }
